...
- Consistency contract: callers supply an expected generation. A successful mutation advances it exactly once; a stale caller receives an actionable conflict and chooses whether to retry. The library does not retry indefinitely.
