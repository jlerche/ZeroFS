...
| Metric | Type | Description |
| --- | --- | --- |
| `zerofs_gc_phase_duration_seconds` | histogram | Completed call duration labeled by `capture`, `mark`, `inventory_report`, `inventory_quarantine`, `revalidate`, or `delete` |
...
| `zerofs_gc_reported_candidate_objects_total` | counter | Candidate segment objects proposed by terminal shadow reports |
| `zerofs_gc_reported_candidate_bytes_total` | counter | Candidate bytes proposed by terminal shadow reports |
